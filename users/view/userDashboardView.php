    ...
    public function selectMyBooks () {
		...
		<div class="container-fluid">
			<div class="row" id="searchbox">
				<div class="col-lg-5">
					<form action="userDashboardView.php" method="POST">
			...
			<div class="row">
				...
				<ul class="pagination pagination">
					<?php
					echo "<li><a href='userDashboardView.php?page=1'>".'<'."</a></li> ";
					for ($i=1; $i<=$total_pages; $i++) { 
            			echo "<li><a href='userDashboardView.php?page=".$i."'>".$i."</a></li> "; 
					}
					echo "<li><a href='userDashboardView.php?page=$total_pages'>".'>'."</a></li> ";
					 ?>
  				</ul>
  				</div>
			</div>
